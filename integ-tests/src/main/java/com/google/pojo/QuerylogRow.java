...
public abstract class QuerylogRow {
  ...
  public static QuerylogRow create(
      String abortFlag,
      String acctString,
      long acctStringDate,
      int acctStringHour,
      double acctStringTime,
      double aMPCPUTime,
      double aMPCPUTimeNorm,
      String appID,
      String cacheFlag,
      String calendarName,
      int callNestingLevel,
      ...
      double delayTime,
      double disCPUTime,
      double disCPUTimeNorm,
      int errorCode,
      double estMaxRowCount,
      double estMaxStepTime,
      double estProcTime,
      double estResultRows,
      String expandAcctString,
      long firstRespTime,
      long firstStepTime,
      String flexThrottle,
      int impactSpool,
      int internalRequestNum,
      int iODecayLevel,
      int iterationCount,
      String keepFlag,
      long lastRespTime,
      ...
      String logonSource,
      double lSN,
      double maxAMPCPUTime,
      double maxAMPCPUTimeNorm,
      double maxAmpIO,
      int maxCPUAmpNumber,
      int maxCPUAmpNumberNorm,
      int maxIOAmpNumber,
      int maxNumMapAMPs,
      int maxOneMBRowSize,
      double maxStepMemory,
      int maxStepsInPar,
      double minAmpCPUTime,
      double minAmpCPUTimeNorm,
      double minAmpIO,
      int minNumMapAMPs,
      double minRespHoldTime,
      int numFragments,
      int numOfActiveAMPs,
      int numRequestCtx,
      double numResultOneMBRows,
      double numResultRows,
      int numSteps,
      int numStepswPar,
      String paramQuery,
      double parserCPUTime,
      double parserCPUTimeNorm,
      double parserExpReq,
      long persistentSpool,
      byte[] procID,
      String profileID,
      String profileName,
      String proxyRole,
      ...
      double seqRespTime,
      int sessionID,
      String sessionTemporalQualifier,
      long spoolUsage,
      long startTime,
      String statementGroup,
      int statements,
      String statementType,
      int sysDefNumMapAMPs,
      int tacticalCPUException,
      int tacticalIOException,
      double tDWMEstMemUsage,
      double throttleBypassed,
      double totalFirstRespTime,
      double totalIOCount,
      long totalServerByteCount,
      String tTGranularity,
      String txnMode,
      String txnUniq,
      String unitySQL,
      double unityTime,
      ...
      byte[] userID,
      String userName,
      int utilityByteCount,
      String utilityInfoAvailable,
      double utilityRowCount,
      double vHLogicalIO,
      double vHLogicalIOKB,
      double vHPhysIO,
      double vHPhysIOKB,
      String warningOnly,
      String wDName) {
    return new AutoValue_QuerylogRow(
        abortFlag,
        acctString,
        acctStringDate,
        acctStringHour,
